...
insert into rleviolation(message,EventId_challan,log_action,log_timestamp)values('rule violated',@EventId_challan,@log_action,getdate());
else
insert into rleviolation(message,EventId_challan,log_action,log_timestamp)values('',@EventId_challan,@log_action,getdate());
print'after inserted triggered fired'

GO
CREATE TRIGGER violationafterupdation on DELIVERYCHALLAN AFTER update
AS
DECLARE @Amount int;
DECLARE @EventId_challan int;
DECLARE @log_action varchar(20);
...
INSERT INTO DELIVERYCHALLAN VALUES('3219','013','5115','BZ215','15 may 2020','1','93600','1');
INSERT INTO DELIVERYCHALLAN VALUES('1536','095','5117','BZ116','16 may 2020','1','77150','1');
INSERT INTO DELIVERYCHALLAN VALUES('2219','032','5113','BZ998','17 may 2020','1','9','1');
INSERT INTO DELIVERYCHALLAN VALUES('2019','043','5114','BZ628','18 may 2020','1','62718','1');
INSERT INTO DELIVERYCHALLAN VALUES('6223','064','5112','BZ348','19 may 2020','1','26271','1');
INSERT INTO DELIVERYCHALLAN VALUES('8362','053','5116','BZ438','20 may 2020','1','5000','1');
INSERT INTO DELIVERYCHALLAN VALUES('7336','087','5115','BZ728','21 may 2020','1','8378123','1');

select * from rleviolation; -----Output for first trigger-----

UPDATE DELIVERYCHALLAN SET AMOUNT='987' WHERE ChallanNo='3219'
UPDATE DELIVERYCHALLAN SET AMOUNT='73821' WHERE ChallanNo='1536'
UPDATE DELIVERYCHALLAN SET AMOUNT='93728' WHERE ChallanNo='2219'
UPDATE DELIVERYCHALLAN SET AMOUNT='6000' WHERE ChallanNo='2019'
UPDATE DELIVERYCHALLAN SET AMOUNT='3627' WHERE ChallanNo='6223'
UPDATE DELIVERYCHALLAN SET AMOUNT='8376372' WHERE ChallanNo='8362'
UPDATE DELIVERYCHALLAN SET AMOUNT='26173' WHERE ChallanNo='7336'

select * from violationafterupdate; -----Output for second trigger-----
